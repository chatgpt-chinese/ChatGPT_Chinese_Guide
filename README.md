...
本项目为用户提供全面的 **[ChatGPT 中文版](https://xsimplechat.com)使用指南**，同时整理了国内可用的 [**ChatGPT镜像网站**](https://chat.lanjingai.org) 和 **官网使用教程**，帮助您快速上手 ChatGPT，无论是个人使用还是专业需求。
...
|----------------------|---------------------|--------------|---------------------|------------|---------------------------------------------|
| [chat.lanjingai.org](https://chat.lanjingai.org)   | GPT-4, GPT-3.5，deepseek-r1，GPT-o3 | 有              | 国内邮箱支持        | ⭐⭐⭐⭐⭐    | 运营时长两年，支持 GPT-4o，内置 4o 绘图，适合开发者与普通用户 |
